...
9. **.golden files:** Do **NOT** regenerate these files in between iterations as they are the source of truth. Only regenerate these files when the expected output or fix is confirmed by the developer.
