...
func (s *stream) writeCSS(b *strings.Builder) {
	...
	b.WriteString(".mdf-heading{display:inline-block;box-sizing:border-box;width:100%;white-space:normal;overflow-wrap:anywhere;padding-left:var(--mdf-heading-indent);text-indent:calc(-1 * var(--mdf-heading-indent));vertical-align:top;}\n")
...
func (s *stream) writeRune(r rune, style mdf.Style) error {
	...
	if s.atLineStart && !s.headingActive && s.headingLevel(style) > 0 {
